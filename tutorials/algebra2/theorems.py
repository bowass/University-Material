...
class LyxParser:
    def __init__(self, file_name):
        ...
        self.begin_layot_pattern = re.compile(r'\\begin_layout\s(Theorem|Lemma$)')
        ...
        self.theorems_dict = {'Claim': '\\color blue\n טענה',
                              'Theorem': '\\color red\n משפט',
    ...
    def create_parsed_file(self):
        ...
        file_with_theorems = self.generate_enumerated_theorems_latex()
        file_name_no_extension = self.no_extension_pattern.match(self.file_name)
        new_file_name = file_name_no_extension.group(1) + '_theorems.lyx'
